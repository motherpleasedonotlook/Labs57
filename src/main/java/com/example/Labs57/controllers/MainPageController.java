...
public class MainPageController {
    ...
    @GetMapping("/")
    public String banners(@RequestParam(name = "title",required = false) String title, Model model) {
    ...
    public String createBanner(@RequestParam("file1") MultipartFile file1,@RequestParam("file2") MultipartFile file2,@RequestParam("file3") MultipartFile file3, Banner banner) throws IOException {
        bannerService.saveBanner(banner, file1,file2,file3);
        return "redirect:/";
    }
